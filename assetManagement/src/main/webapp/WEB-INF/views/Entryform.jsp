...
<body>
    <form id="entryform" modelAttribute="EntryForm" action="entryForm" method="post" onsubmit="return validateentryform();">
     
  

      <div style="border:1px solid gray; border-radius:15px;height:auto;width:850px;padding: 20px;background-color:#FFFAF0;">
      <div class="topnav">
        ...
        <div style="width: 100%;">
            <div style="width: 50%; float: left;"> 
               ...
               <div class="inputbox">
                ...
                <div class="inputbox">
                    <label>Make/Model:<span>*</span></label>
                    <input  type="text" id="makeandmodel" name="makeandmodel" placeholder="Make/Model" />
                </div>
                ...
                <div class="inputbox">
                    ...
                    <input   type="text"  id="processordetails" name="processordetails" placeholder="Processor" />
                </div>
               ...
               <div class="inputbox">
                ...
                <div class="inputbox">
					...
					<input   type="text"  id="invoiceno" name="invoiceno" placeholder="Invoice Number" />
                </div>
				
                <div class="inputbox">
					<label>Invoice Date:<span>*</span></label>
					<input   type="date"  id="invoicedate" name="invoicedate" placeholder="Invoice Date"  />
                </div>
            ...
            <div style="width: 50%;float:right;"> 
                <div class="inputbox">
					<label>Hardware AssetId:<span>*</span></label>
                ...
                <div class="inputbox">
                    <label>Asset Location:<span>*</span></label>
                ...
                <div class="inputbox">
                 ...
                 <div class="inputbox">
                    ...
                    <select id="department" name="department"  placeholder="Department">
					  <option value="" style='disabled'>Choose Department</option>
				      ...
				      <option value="NonPractice">NonPractice</option>
        ...
        function validateentryform(){
        	               ...
        	               if(!assetType){
        	                   isError=false;
        	                     ...
        	                     $("#assettype").css("border-width","medium");
        	               ...
        	               if(!model){
        	                   ...
        	                   $("#makeandmodel").css("border-width","medium");
        	                   return false;
        	               }
        	               if(!serialnumber){
        	                   isError=false;
        	                     $("#serialno").css("border-color","red");
        	                     $("#serialno").css("border-width","medium");
        	                     return false;
        	               }
        	               if(!invoicenumber){
        	                   isError=false;
        	                     $("#invoiceno").css("border-color","red");
        	                     $("#invoiceno").css("border-width","medium");
        	                     return false;
        	               }
        	               if(!invoicedate){
        	                   isError=false;
        	               ...
        	               if(!hardwareAssetId){
        	                   isError=false;
        	                     ...
        	                     $("#hardwareassetid").css("border-width","medium");
        	                     return false;
        	               }
        	               ...
        	               if(!currentStatus){
        	                   isError=false;
        	                     ...
        	                     $("#currentstatus").css("border-width","medium");
        	                     return false;
        	               }
        	               if(!assetlocation){
        	                   isError=false;
        	                     $("#assetloc").css("border-color","red");
        	                     $("#assetloc").css("border-width","medium");
        	                     return false;
        	               }
